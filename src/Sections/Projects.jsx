...
function Projects() {
	return (
		<section className='w-full h-fit pb-30 bg-black relative z-[99] text-white font-bold shadow-top items-center flex flex-col'>
			...
			<h2 className='text-xl md:text-4xl mb-16 text-center'>
				SCALING TO SERVER, DESIGNED TO IMPRESS
			</h2>

			<div
				className='pl-15 flex overflow-x-auto no-scrollbar snap-x snap-mandatory md:flex-col md:gap-10 
							gap-20  w-full items-center'>
